...
function draw()
{
  ...
  if(gameState === win)
  {
    ...
    var unnamed = createElement("h4");
    unnamed.position(0, 200);
      unnamed.html("credits go to Ankitha ma'am and Vedanth Nayak... (mostly ankitha maam all vedanth did was type lmao)");
    }
  ...
  if (gameState === end)
  {
    ...
    obstacle = [];
    background(0, 255, 255);
    var endText = createElement("h1");
    endText.html("game over!")
    endText.position(50, 170);
    var restartBtn = createButton("restart!");
    restartBtn.position(250, 200);
